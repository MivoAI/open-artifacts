...
```bash
cp -R packages/render-decision-board packages/render-my-board
```

Rename the copied npm package to `@open-artifacts/render-my-board`, then run `npm install` from the
